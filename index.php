...
<head>
  ...
  <script src="https://apis.mapmyindia.com/advancedmaps/v1/36d71622-e20e-48ca-b310-f8cdb4ef74f4/map_load?v=1.5">
  </script>
  <script src="https://apis.mapmyindia.com/advancedmaps/api/36d71622-e20e-48ca-b310-f8cdb4ef74f4/map_sdk_plugins">
  </script>
...
<body>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" name="loginemail" id="loginemail" aria-describedby="eemailId"
                placeholder="Email">
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary float-end" data-bs-dismiss="modal" data-bs-toggle="modal"
              data-bs-target="#forgetpasswordModal">Forget Password</button>
          </div>
        </div>
      </div>
    </div>
  ...
  <form method="post" id="forgotpasswordform">
    <!-- Modal Body -->
    <!-- if you want to close by clicking outside the modal, delete the last endpoint:data-bs-backdrop and data-bs-keyboard -->
    <div class="modal fade" id="forgetpasswordModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
      role="dialog" aria-hidden="true">
      <div class="modal-dialog  modal-dialog-centered modal-md">
        <div class="modal-content">
          <div class="modal-header">
